...
import tiandyiconcart from "@/app/assets/icons/tiandyiconcart.svg";
import vabimagecart from "@/app/assets/image/vabimagecart.png";
import Image from "next/image";
import tiandyimagecart from "@/app/assets/image/tiandyimagecart.png";
...
const slides = [
  () => (
    <div className="flex items-center gap-5">
      ...
      />
      <div className="bg-black rounded-2xl h-[420px] flex items-center">
        <Image src={tiandyimagecart} alt="tiandyimagecart" />
      </div>
    </div>
  ),
  () => (
...
export default function Tiandy_leader() {
