...
import dahuaiconcart from "@/app/assets/icons/dahuaiconcart.svg";
import vabimagecart from "@/app/assets/image/vabimagecart.png";
import Image from "next/image";
import cameracard from "@/app/assets/image/cameracard.png";
...
const slides = [
  () => (
    <div className="flex items-center gap-5">
      ...
      />
      <Image src={cameracard} alt="cameracard" height={480} />
    </div>
  ),
  () => (
    <div className="flex items-center gap-5">
...
export default function Dahua_leader() {
      ...
      <div className="flex flex-col w-full h-auto">
        <div className="flex items-center justify-between pb-7">
          <p className="text-2xl">
            Лидеры продаж от <span className="font-bold">Dahua Technology</span>
          </p>
          <div className="flex gap-5 rounded-full bg-white p-2">
            <button onClick={prev}>
              <Image src={arrowslaid} alt="arrow left" className="cursor-pointer" />
            </button>
            <button onClick={next}>
              <Image
                src={arrowslaid}
